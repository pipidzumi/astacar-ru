  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 w-full">
      ...
      <div className="space-y-4">
        <h3 className="font-semibold text-sm mb-4">Основные параметры</h3>
      ...
      {/* Auction parameters */}
      <div className="space-y-4">
        <h3 className="font-semibold text-sm mb-4">Параметры аукциона</h3>
      ...
      {/* Condition */}
      <div className="space-y-4">
        <h3 className="font-semibold text-sm mb-4">Состояние и история</h3>
      ...
      {/* Seller info */}
      <div className="space-y-4">
        <h3 className="font-semibold text-sm mb-4">Продавец и медиа</h3>
