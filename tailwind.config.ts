...
export default {
        ...
        theme: {
                ...
                extend: {
                        fontFamily: {
                                sans: ["Mulish", "ui-sans-serif", "system-ui", "-apple-system", "Segoe UI", "Roboto", "Helvetica Neue", "Arial", "Noto Sans", "Liberation Sans", "sans-serif"],
                        },
                        colors: {
                                ...
                                auction: {
                                        ...
                                        ending: 'hsl(var(--auction-ending))',
                                        closed: 'hsl(var(--auction-closed))',
                                        reserve: 'hsl(var(--auction-reserve))'
                                },
                                success: {
